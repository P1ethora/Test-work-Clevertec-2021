...
//        log.info("Request for comment " + id);
...
//        log.info("Request to add a comment " + jsonComment );
...
//        log.info("Request to update a comment " + jsonComment);
        try {
...
//        log.info("Request to delete a comment " + id);
